...
#show: report.with(
  ...
  status: (group: status.neutral, project: status.neutral, progress: status.neutral),
  overview: (highlights: ("",), well: ("Team Communication",), improvements: ("",), help: (),)
)

#slide(heading: [Relevant Events])[
  #timeline(
    (
      (date: "May 15", desc: "Intra-Team Disccusion for Working  Packages and Mockup"),
      (date: "May 19/20/22", desc: "CodeTraining with ccc"),
