...
#slide(heading: [Relevant Events])[
  #timeline(
    (
      (date: "May 06", desc: "Design of Working Packages and First Mockup"),
      (date: "May 07", desc: "Review of initial design concepts with ccc"),
      (date: "May 19", desc: "Optimazation of concepts/Codetraining with CCC")
    ),
