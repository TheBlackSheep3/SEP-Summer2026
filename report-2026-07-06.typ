...
#show: report.with(
  ...
  overview: (highlights: ("We are finding our way through imaso","Multiple user stories tackled, while having no blockers",), well: ("We got a Codex license from the customer",), improvements: ("Team Capacity: Currently one team member on sick leave",), help: (),)
)
...
#slide(heading: [Relevant Events])[
  #timeline(
    (
      (date: "July 06", desc: "Demo Session"),
      (date: "July 09", desc: "Demo Status Quo to Customer"),
      (date: "July 10", desc: "If approved, start connecting to BE"),      
    ),
